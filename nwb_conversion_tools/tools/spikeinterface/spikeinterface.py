...
def add_units_table(
    ...
    write_units_table_in_processing_module: Optional[Boolean] = False,
):
    """
    ...
    write_units_table_in_processing_module: bool (optional, defaults to False)
    ...
    if not write_units_table_in_processing_module:
...
def write_sorting(
    ...
    if write_as == "units":
        ...
        units_table_description = units_table_description
