...
def add_units(
    ...
    property_descriptions: dict = dict(),
    skip_properties: Optional[List[str]] = list(),
    units_table_name: str = "units",
    unit_table_description: str = "Autogenerated by nwb_conversion_tools.",
    write_table_as_processing: Optional[Boolean] = False,
):
    """
    ...
    write_table_as_processing: bool (optional, defaults to False)
    ...
    if not write_table_as_processing:
        units_table_name == "units"

    if write_table_as_processing:
        ecephys_mod = get_module(
            nwbfile=nwbfile,
            name="ecephys",
            description="Intermediate data from extracellular electrophysiology recordings, e.g., LFP.",
...
def write_sorting(
    ...
    overwrite: bool = False,
    nwbfile: Optional[pynwb.NWBFile] = None,
    property_descriptions: Optional[dict] = dict(),
    skip_properties: Optional[List[str]] = list(),
    ...
    if nwbfile is None:
        ...
        with pynwb.NWBHDF5IO(str(save_path), mode=read_mode) as io:
            ...
            add_units(
                ...
                write_table_as_processing=write_table_as_processing,
