...
def add_units(
    ...
    unit_table_description : str (optional)
        Text description of the units table; recommended to included parameters of sorting method, curation, etc.
    """
    ...
    # Add data by rows excluding the rows containing unit names that were previously added
